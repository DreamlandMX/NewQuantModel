...
export function ForecastDistribution({ items }: { items: ForecastRecord[] }) {
  ...
  return (
    <ReactECharts
      ...
      option={{
        ...
        tooltip: {
          trigger: "axis",
          valueFormatter: (value: number) => formatSignedPercent(value, 2)
        },
        ...
        yAxis: {
          type: "value",
          axisLabel: { color: "#90A4AE", formatter: (value: number) => `${(value * 100).toFixed(1)}%` },
