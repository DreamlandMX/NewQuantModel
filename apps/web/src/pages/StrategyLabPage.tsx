...
import { formatDualTime, formatModelVersion, formatPercent, formatRebalance, formatStrategyMode } from "../lib/formatters";

export function StrategyLabPage({ backtest }: { backtest: BacktestSummary | null }) {
